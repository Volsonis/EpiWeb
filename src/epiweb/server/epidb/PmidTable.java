...
/** Strongly typed access to the database table "pmid".
 *
 ...
 *
 */
public class PmidTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "pmid";

    public static final String pmidColumnName = "pmid";
    public static final String yearColumnName = "year";
    public static final String ordernumberColumnName = "ordernumber";

    private static String[] allColumns =
    {
        pmidColumnName , yearColumnName , ordernumberColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockPmidTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( PmidTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Map buildDataMap()
        {
            ...
            data.put( pmidColumnName , String.valueOf(  this.pmid ) );
            data.put( yearColumnName , this.yearNull ? null : String.valueOf( this.year ) );
            data.put( ordernumberColumnName , String.valueOf(  this.ordernumber ) );
            return data ;
        }
