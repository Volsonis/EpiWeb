...
/** Strongly typed access to the database table "covariate".
 *
...
public class CovariateTable
{
    ...
    public static final String other_covariateColumnName = "other_covariate";

    private static String[] allColumns =
    {
        pmidColumnName , yearColumnName , covariateColumnName , umls_groupColumnName , umls_categoryColumnName , other_covariateColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockCovariateTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( CovariateTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private String other_covariate ;
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.covariate = data[2];
                this.umls_group = data[3];
                this.umls_category = data[4];
                this.other_covariate = data[5];
        ...
        public String getOther_covariate()
        {
            return other_covariate ;
        }

        public void setOther_covariate( String other_covariate )
        {
            this.other_covariate = other_covariate ;
        }
        ...
        private Map buildDataMap()
        {
            ...
            data.put( covariateColumnName , this.covariate );
            data.put( umls_groupColumnName , this.umls_group );
            data.put( umls_categoryColumnName , this.umls_category );
            data.put( other_covariateColumnName , this.other_covariate );
            return data ;
        }
