...
/** Strongly typed access to the database table "movies".
 *
...
public class MoviesTable
{
    ...
    public static final String genreColumnName = "genre";
    public static final String yearColumnName = "year";
    public static final String languangeColumnName = "languange";

    private static String[] allColumns =
    {
        titleColumnName , genreColumnName , yearColumnName , languangeColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockMoviesTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( MoviesTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                this.title = data[0];
                this.genre = data[1];
                this.yearNull = ( data[2] == null );
                this.year = yearNull ? 0 : Str.toInt( data[2] );
                this.languange = data[3];
        ...
        private Map buildDataMap()
        {
            ...
            data.put( genreColumnName , this.genre );
            data.put( yearColumnName , this.yearNull ? null : String.valueOf( this.year ) );
            data.put( languangeColumnName , this.languange );
            return data ;
        }
