...
/** Strongly typed access to the database table "outcome".
 *
...
public class OutcomeTable
{
    ...
    public static final String outcomeColumnName = "outcome";
    ...
    public static final String other_outcomeColumnName = "other_outcome";

    private static String[] allColumns =
    {
        pmidColumnName , yearColumnName , outcomeColumnName , umls_groupColumnName , umls_categoryColumnName , other_outcomeColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockOutcomeTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( OutcomeTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        public String getOther_outcome()
        {
            return other_outcome ;
        }

        public void setOther_outcome( String other_outcome )
        {
            this.other_outcome = other_outcome ;
        }
